-- Public profile history RPC (privacy-scoped read model).
-- Exposes curated finished-game timeline fields only.
...
comment on function public.get_public_profile_history(uuid, integer) is
  'Privacy-scoped public finished-game timeline for profile pages. Curated fields only.';
