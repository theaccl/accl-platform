-- Zero-move and pre-first-move abandonment: no competitive rating penalty.
...
comment on function public.apply_free_play_rating_update_core(uuid) is
  'Dual-write rating apply; skips 0-move finishes and abandoned_before_move / no_first_move end reasons.';
