-- Live queue busy checks must only consider **tempo = live** rows.
-- Previously, any seated active/waiting two-player game (including daily/correspondence) blocked
-- live open-seat joins and live direct inserts — incorrect for async + live concurrency.
