          ...
          <p className="text-[10px] leading-snug text-gray-500">
            {openByClock[selectedClock]!.rated > 0 && openByClock[selectedClock]!.unrated > 0 ? (
              <>
                Also waiting:{' '}
                {selectedRated ? (
                  <button type="button" className="font-semibold text-gray-300 underline" onClick={() => onRatedChange(false)}>
                    Unrated — {openByClock[selectedClock]!.unrated} open
                  </button>
                ) : (
                  <button type="button" className="font-semibold text-amber-200/90 underline" onClick={() => onRatedChange(true)}>
